...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if min(self.input_resolution) <= self.window_size:
            ...
            #print('Input resolution is less than Window Size')
            self.shift_size = 0
    ...
    def forward(self, x, x_size):
        h, w = x_size
        #print(f'X shape on Transformer Block: {x.shape}')
        b, _, c = x.shape
        ...
        #print(f'Window Size within ST Block: {self.window_size}')
        # partition windows
...
class BasicLayer(nn.Module):
    ...
    def __init__(self,
       ...
       #print(f'Window Size within Basic Layer: {window_size}')
...
class RSTB(nn.Module):
    ...
    def __init__(self,
       ...
       #print(f'Window Size within RSTB: {window_size}')
...
class SwinFIR(nn.Module):
    ...
    def __init__(self,
        ...
        #print(f'Window Size within SwinFIR: {window_size}')
    ...
    def forward_features(self, x):
        ...
        print(f'SHAPE BEFORE PATCH EMBED: {x.shape}')
        x = self.patch_embed(x)
        print(f'SHAPE AFTER PATCH EMBED: {x.shape}')
        if self.ape:
